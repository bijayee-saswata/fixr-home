        ...
        <div class="grid">
            <div class="serviceImage">
                ...
                <div class="price">
                    ...
                    <button class="btn btn-success" data-toggle="modal" data-target="#modal" @click="addServices()">Order Now</button>
                </div>
            </div>
...
export default {
    ...
    created () {
        db.collection("ServiceTypes").doc(this.parent).collection('sub').doc(this.slug).get().then(doc => {
